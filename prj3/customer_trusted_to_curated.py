...
accelerometer_trusted_node1715524540940 = glueContext.create_dynamic_frame.from_catalog(database="stedi",
                                                                                        table_name="accelerometer_trusted",
                                                                                        transformation_ctx="accelerometer_trusted_node1715524540940")

# Script generated for node Join
Join_node1715524559952 = Join.apply(frame1=customer_trusted_node1715524543007,
                                    frame2=accelerometer_trusted_node1715524540940, keys1=["email"], keys2=["user"],
...
AmazonS3_node1715524650585 = glueContext.write_dynamic_frame.from_options(frame=SQLQuery_node1715525789328,
                                                                          ...
                                                                          connection_options={
                                                                              "path": "s3://pmt-bucket-us-east-2/stedi/customer/curated/",
                                                                              "partitionKeys": []},
